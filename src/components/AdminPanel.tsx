    ...
    <div className="min-h-screen bg-farm-cream relative" style={{ zIndex: 10 }}>
      ...
      <div className="bg-farm-green-dark text-white px-4 py-3 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="text-white/50 text-sm">КФХ Кенеш</span>
        </div>
        <div className="flex items-center gap-3">
          <button
          ...
          <>
            ...
            <div className="space-y-3">
              {products.map(product => (
                <div key={product.id} className="bg-white rounded-xl p-4 flex items-center gap-4 border border-farm-cold/30 hover:shadow-sm transition-shadow">
                  ...
                  <div className="flex-grow min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-farm-dark/40">{product.description}</span>
                    </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <select value={product.status} onChange={e => handleStatusChange(product.id, e.target.value as ProductStatus)}
                      className="text-xs px-2 py-1 rounded-lg border border-farm-cold bg-white text-farm-dark outline-none">
                      <option value="available">В наличии</option>
                      <option value="soon">Скоро будет</option>
                      <option value="unavailable">Нет в наличии</option>
                    </select>
